    ...
    >
      <div className="flex flex-col min-h-dvh justify-center items-center">
        ...
        <div className="flex flex-col gap-6 md:gap-8 max-w-xl w-full mx-auto">
          ...
          <Item variant={"muted"} className="bg-green-900 mt-1">
            <ItemMedia variant="icon" className="m-auto w-full">
              <CheckCircleIcon className="size-5 md:size-6 text-white" />
            </ItemMedia>

            <ItemDescription className="w-full text-base md:text-lg text-white text-center">
              <p className="text-base md:text-xl">
                Tudo feito com segurança jurídica e acompanhamento profissional.
              </p>
            </ItemDescription>
            <ItemDescription className="w-full text-base md:text-lg text-white text-center">
              <p className="text-base md:text-xl">
